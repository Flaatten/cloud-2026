...
```yaml
  ...
  WebServerInstance:
    ...
    Properties:
      ImageId: ami-05edf2d87fdbd91c1  # Amazon Linux 2023 AMI in eu-west-3
      ...
      UserData:
        Fn::Base64: |
          ...
          const LAMBDA_BASE_URL = 'https://rsz4gecta74rbeuypqfjadpsde0xkyha.lambda-url.eu-west-3.on.aws';
